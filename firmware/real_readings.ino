...
void setup() {
  ...
  delay(1000);
  Serial.println("--- REAL READING MONITOR ---");
}
...
void loop() {
  ...
  // ==========================================
  // STEP 2: READ TDS (TDS ON)
  // ==========================================
  digitalWrite(tdsPowerPin, HIGH);
  delay(200); // 200ms warmup
  ...
  // CALCULATE REAL TDS
  // (Assuming 25.0C temperature for standard reading)
