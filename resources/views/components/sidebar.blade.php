<aside class="w-64 bg-white border-r border-gray-200 flex flex-col h-screen shadow-sm">
    ...
    <nav class="flex-1 px-3 mt-6 space-y-2">
        ...
        <a href="{{ route('users.index') }}" 
           class="flex items-center px-4 py-3 rounded-lg transition duration-200 {{ request()->routeIs('users.index') ? 'bg-indigo-100 text-indigo-600 font-semibold' : 'text-gray-700 hover:bg-gray-100' }}">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
