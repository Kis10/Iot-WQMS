                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="p-4 rounded-xl bg-emerald-50 border border-emerald-100">
                                    <h3 class="font-bold text-emerald-900 mb-2 flex justify-between">
                                        pH Level <span>6.5 - 8.5</span>
                                    </h3>
                                    <p class="text-xs text-emerald-700 leading-relaxed italic">"Optimal for nutrient availability and fish metabolism. Below 6.0 causes slow growth; above 9.0 increases ammonia toxicity."</p>
                                </div>
                                ...
                                <div class="p-4 rounded-xl bg-orange-50 border border-orange-100">
                                    ...
                                    <p class="text-xs text-orange-700 leading-relaxed italic">"Controls the metabolic rate of fish. Tilapia productivity peaks in this range. Above 32°C, oxygen solubility drops."</p>
                                </div>
                                <!-- TDS Standard -->
                                <div class="p-4 rounded-xl bg-purple-50 border border-purple-100">
                                    <h3 class="font-bold text-purple-900 mb-2 flex justify-between">
                                        TDS <span>100 - 500 ppm</span>
                                    </h3>
                                    <p class="text-xs text-purple-700 leading-relaxed italic">"Measures inorganic salts and organic matter. High TDS (>1000) stresses the osmoregulation of freshwater fish."</p>
                                </div>
                                <!-- Turbidity Standard -->
                                <div class="p-4 rounded-xl bg-blue-50 border border-blue-100">
                                    <h3 class="font-bold text-blue-900 mb-2 flex justify-between">
                                        Turbidity <span>50 - 100%</span>
                                    </h3>
                                    <p class="text-xs text-blue-700 leading-relaxed italic">"Clarity is vital for light penetration and gill health. Muddy water (below 20%) stunts growth and clogs gills."</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-6 space-y-6">
                            <div class="flex items-start gap-4 p-4 rounded-xl hover:bg-gray-50 transition">
                                ...
                                <div>
                                    <h4 class="font-bold text-gray-900 underline decoration-indigo-200">pH Composite Electrode</h4>
                                    <p class="text-sm text-gray-600 mt-1">Measures the hydrogen-ion activity in water. Its duty is to detect chemical shifts caused by waste accumulation or rainwater. Data is sampled 10 times per second and averaged for 99.9% accuracy.</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-4 p-4 rounded-xl hover:bg-gray-50 transition">
                                ...
                                <div>
                                    <h4 class="font-bold text-gray-900 underline decoration-purple-200">Analog TDS Sensor</h4>
                                    <p class="text-sm text-gray-600 mt-1">Utilizes electrical conductivity ($EC$) to estimate dissolved solids. Its duty is to monitor mineral balance. High readings trigger the 'Water Change' recommendation in the AI Analyzer.</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-4 p-4 rounded-xl hover:bg-gray-50 transition">
                                ...
                                <div>
                                    <h4 class="font-bold text-gray-900 underline decoration-orange-200">DS18B20 Waterproof Probe</h4>
                                    <p class="text-sm text-gray-600 mt-1">Uses a 1-Wire digital bus for high-precision thermal tracking. Its duty is to regulate the feeding schedule, as fish appetite is directly proportional to water temperature.</p>
                                </div>
                            </div>
                        </div>
                    </div>
