            ...
            <div class="flex-1 bg-white rounded-xl shadow-2xl overflow-hidden border border-gray-200 flex flex-col relative landing-wrapper">
                ...
                <div class="mb-8" x-data="{ editing: false }">
                    ...
                    <div x-show="editing" x-cloak>
                        <textarea x-model="data.hero_title.value" class="input-box text-5xl md:text-7xl lg:text-8xl font-black text-white leading-tight tracking-tight text-center h-auto" rows="2" @click.away="editing = false"></textarea>
                        <p class="text-white/50 text-xs mt-1 text-center font-normal">Supports HTML</p>
                    </div>
                </div>
                ...
                <div class="mb-12" x-data="{ editing: false }">
                    ...
                    <textarea x-show="editing" x-cloak x-model="data.hero_subtitle.value" class="input-box text-xl md:text-2xl text-blue-100 font-medium leading-relaxed text-center h-auto" rows="3" @click.away="editing = false"></textarea>
                </div>            </div>
                        </div>
                    </section>
                    ...
                    <section class="py-24 bg-white overflow-hidden">
                        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                            ...
                            <div class="mb-6 flex justify-center" x-data="{ editing: false }">
                                ...
                                <input x-show="editing" x-cloak x-model="data.mission_badge.value" class="input-box text-sm font-bold text-blue-600 bg-blue-50 rounded-full px-4 py-1.5 text-center w-auto inline-block" @click.away="editing = false">
                            </div>
                            ...
                            <div class="mb-8" x-data="{ editing: false }">
                                ...
                                <input x-show="editing" x-cloak x-model="data.mission_title.value" class="input-box text-4xl font-bold text-gray-900 tracking-tight text-center" @click.away="editing = false">
                            </div>
                            ...
                            <!-- Text -->
                             <div x-data="{ editing: false }">
                                ...
                                <textarea x-show="editing" x-cloak x-model="data.mission_text.value" class="input-box text-xl text-gray-600 leading-relaxed font-light text-center h-auto" rows="4" @click.away="editing = false"></textarea>
                            </div>
                            </div>
                        </div>
                    </section>
                         ...
                         <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div class="text-center mb-16">
                                <div class="mb-4" x-data="{ editing: false }">
                                    ...
                                    <input x-show="editing" x-cloak x-model="data.sensors_title.value" class="input-box text-4xl font-bold text-gray-900 tracking-tight text-center" @click.away="editing = false">
                                </div>
                                 <div x-data="{ editing: false }">
                                    ...
                                    <input x-show="editing" x-cloak x-model="data.sensors_subtitle.value" class="input-box text-gray-500 text-lg text-center" @click.away="editing = false">
                                </div>
                            </div>
                             <!-- Sensors Grid (Static) -->
                         ...
                         <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div class="text-center mb-16">
                                <div class="mb-4" x-data="{ editing: false }">
                                    ...
                                    <input x-show="editing" x-cloak x-model="data.services_title.value" class="input-box text-4xl font-bold text-gray-900 tracking-tight text-center" @click.away="editing = false">
                                </div>
                                 <div x-data="{ editing: false }">
                                    ...
                                    <input x-show="editing" x-cloak x-model="data.services_subtitle.value" class="input-box text-gray-500 text-lg text-center" @click.away="editing = false">
                                </div>
                            </div>
                        </div>
                    </section>
                         ...
                         <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div class="text-center mb-20">
                                <div class="mb-4" x-data="{ editing: false }">
                                    ...
                                    <input x-show="editing" x-cloak x-model="data.contact_title.value" class="input-box text-4xl font-bold text-gray-900 tracking-tight text-center" @click.away="editing = false">
                                </div>
                                 <div x-data="{ editing: false }">
                                    ...
                                    <input x-show="editing" x-cloak x-model="data.contact_subtitle.value" class="input-box text-gray-500 text-lg text-center" @click.away="editing = false">
                                </div>
                            </div>
                        </div>
                    </section>
