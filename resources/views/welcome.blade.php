                ...
                <div class="flex items-center justify-between w-full">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="javascript:void(0)" 
                           onclick="var now=Date.now(); if(now - (window._lastLogoTap||0) < 500){ fetch('/logo-access',{method:'POST',headers:{'X-CSRF-TOKEN':document.querySelector('meta[name=csrf-token]').content}}).then(function(){window.location.href='/login';}); } window._lastLogoTap=now;"
